...
const addBackground = (root) => {
  ...
  bg.src = 'images/cloud-background.jpg';
  ...
  whiteBoxBottom.style.zIndex = 100;
  whiteBoxBottom.style.position = 'absolute';
  whiteBoxBottom.style.top = `-${ENEMY_HEIGHT}px`;
  whiteBoxBottom.style.height = `${ENEMY_HEIGHT}px`;
  whiteBoxBottom.style.width = `${GAME_WIDTH}px`;
  whiteBoxBottom.style.background = 'inherit';
  root.append(whiteBoxBottom);

  
  const whiteBoxTop = document.createElement('div');

  // Made second box to hide the top
  whiteBoxTop.style.zIndex = 100;
  whiteBoxTop.style.position = 'absolute';
  whiteBoxTop.style.top = `${GAME_HEIGHT}px`;
  whiteBoxTop.style.height = `${ENEMY_HEIGHT*2}px`;
  whiteBoxTop.style.width = `${GAME_WIDTH}px`;
  whiteBoxTop.style.background = 'inherit';
  root.append(whiteBoxTop);
